...
def main():
	...
	txt=Text(Point(250,50),'Circle starts the game!')
	...
	while check==False:
		for i in range(9):
			if i%2==0 and check==False:
				...
				#make new text 
				txt=Text(Point(250,50),'Next move: cross')
				txt.setTextColor(color_rgb(255,255,255))
				txt.setSize(30)
				txt.draw(win)
				#count
				...
				drawxo(num,'x')[1].draw(win)
				#make new text
				txt=Text(Point(250,50),'Next move: circle')
				txt.setTextColor(color_rgb(255,255,255))
				txt.setSize(30)
				txt.draw(win)
				#count
	...
	if s <= 9 and check==True and x_count==1:
		txt.undraw()
		txt=Text(Point(250,50),'Cross wins!')
		txt.setTextColor(color_rgb(255,255,255))
		txt.setSize(30)
		txt.draw(win)
	elif s <= 9 and check==True and o_count==1:
		txt.undraw()
		txt=Text(Point(250,50),'Circle wins!')
		txt.setTextColor(color_rgb(255,255,255))
		txt.setSize(30)
		txt.draw(win)	
	else:
		txt.undraw()
		txt=Text(Point(250,50),'Draw!')
		txt.setTextColor(color_rgb(255,255,255))
		txt.setSize(30)
		txt.draw(win)
